  ...
  const rows = [
    createData(
        ...
        createData(
          ...
          ,' شرکت گار','اینستا','۲۸', '۲۸','۲۸','۲۸','۲۸', ),
          createData(
            <Avatar  sx={{ width: 40, height: 40 }} alt="Remy Sharp" src={naft} />,
            <>
            <div className='flex-row w-32'>
            ...
            ,'وزارت نفت','تلگرام','۲۸', '۲۸','۲۸','۲۸','۲۸', ),
            createData(
              <Avatar  sx={{ width: 40, height: 40 }} alt="Remy Sharp" src={naft} />,
              <>
              <div className='flex-row w-32'>
    ...
    <Table sx={{fontFamily : "fontIOS" , borderRadius : '25px'}} className='h-full w-full'  size="small" aria-label="a dense table">
      <TableHead sx={{fontFamily : "fontIOS" , borderRadius : '25px'}}>
        <TableRow >
          ...
          <TableCell sx={{fontFamily : "fontIOS"}} align="right">سازمان</TableCell>
          <TableCell sx={{fontFamily : "fontIOS"}} align="right">پلتفرم</TableCell>
...
export default AccountGharargahList
